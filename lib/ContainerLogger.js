...
class ContainerLogger {
    ...
    constructor(containerId, containerInterface, firebaseLogger, firebaseLastUpdate, firebaseMetricsLogSize, loggerStrategy, valuesToMaskRegex) {
        this.containerId        = containerId;
        this.containerInterface = containerInterface;
        this.firebaseLogger     = firebaseLogger;
        this.firebaseLastUpdate = firebaseLastUpdate;
        this.firebaseMetricsLogSize = firebaseMetricsLogSize;
        this.loggerStrategy     = loggerStrategy;
        this.tty                = false;
        this.valuesToMaskRegex  = valuesToMaskRegex;
        this.logSize            = 0;
    }
    ...
    _logMessageToFirebase(message, isError) {
        if (this.valuesToMaskRegex) {
            message = message.replace(this.valuesToMaskRegex, '*****');
        }
        ...
        this.firebaseMetricsLogSize.set(this.logSize);
    }
