...
class Logger {
    ...
    constructor(loggerId, firebaseAuthUrl, firebaseSecret, findExistingContainers, onDockerNodeTerminationHandler) {
        ...
        logger.warn("Logger created with onDockerNodeTerminationHandler:", onDockerNodeTerminationHandler === undefined);
    }
    ...
    _handleContainer(container) {
        ...
        const containerLogger    = new ContainerLogger(containerId, containerInterface, firebaseLogger, firebaseLastUpdate, loggerStrategy, this.onDockerNodeTerminationHandler);
