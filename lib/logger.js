...
class Logger {
    ...
    constructor({
        ...
        this.docker = new Docker({
            host: '192.168.99.100',
            port: 2376,
            ca: fs.readFileSync('/Users/elad-codefresh/.docker/machine/machines/codefresh/ca.pem'),
            cert: fs.readFileSync('/Users/elad-codefresh/.docker/machine/machines/codefresh/cert.pem'),
            key: fs.readFileSync('/Users/elad-codefresh/.docker/machine/machines/codefresh/key.pem'),
        });
        this._readState();
