...
class ContainerLogger {
    ...
    constructor(containerId, containerInterface, loggerStrategy, logId, logUrl) {
        this.containerId        = containerId;
        this.containerInterface = containerInterface;
        this.loggerStrategy     = loggerStrategy;
        this.logId              = logId;
        this.logUrl             = URL.parse(logUrl);
        this.tty                = false;
    }
    ...
    _logMessageToStreamer(message, isError) {
        ...
        var options = {
          host: this.logUrl.hostname,
          port: this.logUrl.port,
          path: this.logUrl.path,
          method: 'POST',
          json: true,
          headers: {
