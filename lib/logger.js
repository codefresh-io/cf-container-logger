...
class Logger {
    ...
    constructor({
        ...
        this._shouldListenForEngineUpdates = listenForEngineUpdates;
    ...
    start() {
        ...
        if (this._shouldListenForEngineUpdates) {
    ...
    _listenForEngineUpdates() {
        ...
        app.post('/secrets', (req, res) => {
            try {
                const secret = JSON.stringify(res.body);
